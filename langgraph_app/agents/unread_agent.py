...
class UnreadHistoryAgent(BaseAgent):
    ...
    def __init__(self, llm, user_id: str = None, telegram_handler=None):
        ...
        self.llm = llm
        self.telegram_handler = telegram_handler or create_telegram_handler(user_id)  # Optional custom Telegram handler
    ...
    def before_get_unread_history(self):
        ...
        self.unread_chats = self.telegram_handler.get_unread_chats(**self.route.intent_resolution.parameters)
